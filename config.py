...
# quão rápido o watchdog consulta o qBittorrent, com a UI acompanhando: abaixo
# do tick de 1s do detalhe do job, para a barra ler sempre um valor fresco.
POLL_INTERVAL_SECONDS = 0.9
# sem ninguém olhando: ainda detecta stall/torrent sumido, com ~5x menos carga.
POLL_IDLE_INTERVAL_SECONDS = 5.0
# por quanto tempo uma consulta da UI mantém o ritmo rápido.
